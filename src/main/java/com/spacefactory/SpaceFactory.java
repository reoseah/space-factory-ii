...
public class SpaceFactory {
    ...
    public static final Block MAGENTA_SPACEGLAZE = new GlazedTerracottaBlock(AbstractBlock.Settings.create().mapColor(DyeColor.MAGENTA).strength(5F, 15F).allowsSpawning(SpaceFactory::none).pistonBehavior(PistonBehavior.PUSH_ONLY));
    ...
    public static final Block MAGENTA_SPACEGLAZE_PANEL = new Block(AbstractBlock.Settings.create().mapColor(DyeColor.MAGENTA).strength(5F, 15F).allowsSpawning(SpaceFactory::none).pistonBehavior(PistonBehavior.PUSH_ONLY));
    ...
    public static void initialize() {
        ...
        Registry.register(Registries.BLOCK, "spacefactory:magenta_spaceglaze", MAGENTA_SPACEGLAZE);
        ...
        Registry.register(Registries.BLOCK, "spacefactory:magenta_spaceglaze_panel", MAGENTA_SPACEGLAZE_PANEL);
        ...
        Registry.register(Registries.ITEM, "spacefactory:magenta_spaceglaze", new BlockItem(MAGENTA_SPACEGLAZE, new Item.Settings()));
        Registry.register(Registries.ITEM, "spacefactory:magenta_spaceglaze_panel", new BlockItem(MAGENTA_SPACEGLAZE_PANEL, new Item.Settings()));
        ...
        ItemGroup itemGroup = FabricItemGroup.builder()
                ...
                .entries((displayContext, entries) -> {
                    ...
                    entries.add(MAGENTA_SPACEGLAZE);
                    ...
                    entries.add(MAGENTA_SPACEGLAZE_PANEL);
